...
const (
	...
	osDarwin                  = "darwin"
	osLinux                   = "linux"
	winExecutable             = "Scripts"
	lxExecutable              = "bin"
	manifestFile              = "requirements.txt"
	placeholderPkgName        = "{PACKAGE}"
	placeholderExecutableName = "{executable}"
)

var (
	errDependenciesNotFound   = errors.New("unable to generate SPDX file: no modules or vendors found. Please install them before running spdx-sbom-generator, e.g.: `pip install -r requirements.txt`")
	errNoPipCommand           = errors.New("cannot find the python command")
